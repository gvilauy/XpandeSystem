...
public class ADField extends PO implements I_AD_Field, I_Persistent
{
    ...
    public ADField (Properties ctx, int AD_Field_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public ADField (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADField[")
