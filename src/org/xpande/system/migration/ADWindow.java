...
public class ADWindow extends PO implements I_AD_Window, I_Persistent
{
    ...
    public ADWindow (Properties ctx, int AD_Window_ID, String trxName)
    {
...
// M
    ...
    /** Load Constructor */
    public ADWindow (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADWindow[")
