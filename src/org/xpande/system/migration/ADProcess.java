...
public class ADProcess extends PO implements I_AD_Process, I_Persistent
{
    ...
    public ADProcess (Properties ctx, int AD_Process_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public ADProcess (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADProcess[")
	...
	{
		set_Value (COLUMNNAME_GenerateClass, GenerateClass);
	}

	/** Get Generate Class.
		@return Generate Class Button
	  */
	public String getGenerateClass () 
	{
		return (String)get_Value(COLUMNNAME_GenerateClass);
	}
