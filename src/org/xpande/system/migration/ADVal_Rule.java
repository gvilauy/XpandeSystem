...
public class ADVal_Rule extends PO implements I_AD_Val_Rule, I_Persistent
{
    ...
    public ADVal_Rule (Properties ctx, int AD_Val_Rule_ID, String trxName)
    {
...
// U
    ...
    /** Load Constructor */
    public ADVal_Rule (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADVal_Rule[")
