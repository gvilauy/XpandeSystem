...
public class ADProcessPara extends PO implements I_AD_Process_Para, I_Persistent
{
    ...
    public ADProcessPara (Properties ctx, int AD_Process_Para_ID, String trxName)
    {
...
// @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Process_Para WHERE AD_Process_ID=@AD_Process_ID@
    ...
    /** Load Constructor */
    public ADProcessPara (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADProcessPara[")
    ...
    {
		return (org.compiere.model.I_AD_Element) MTable.get(getCtx(), I_AD_Element.Table_Name)
