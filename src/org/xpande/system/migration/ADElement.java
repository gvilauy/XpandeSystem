...
public class ADElement extends PO implements I_AD_Element, I_Persistent
{
    ...
    public ADElement (Properties ctx, int AD_Element_ID, String trxName)
    {
...
// U
    ...
    /** Load Constructor */
    public ADElement (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADElement[")
