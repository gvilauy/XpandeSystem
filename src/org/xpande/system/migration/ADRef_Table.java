...
public class ADRef_Table extends PO implements I_AD_Ref_Table, I_Persistent
{
    ...
    public ADRef_Table (Properties ctx, int AD_Ref_Table_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public ADRef_Table (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADRef_Table[")
