...
public class ADColumn extends PO implements I_AD_Column, I_Persistent
{
    ...
    public ADColumn (Properties ctx, int AD_Column_ID, String trxName)
    {
...
// Y
    ...
    /** Load Constructor */
    public ADColumn (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADColumn[")
    ...
    {
		return (org.compiere.model.I_AD_Chart) MTable.get(getCtx(), I_AD_Chart.Table_Name)
