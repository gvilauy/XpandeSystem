...
public class ADReference extends PO implements I_AD_Reference, I_Persistent
{
    ...
    public ADReference (Properties ctx, int AD_Reference_ID, String trxName)
    {
...
// U
    ...
    /** Load Constructor */
    public ADReference (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADReference[")
