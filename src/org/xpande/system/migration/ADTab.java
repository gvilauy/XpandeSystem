...
public class ADTab extends PO implements I_AD_Tab, I_Persistent
{
    ...
    public ADTab (Properties ctx, int AD_Tab_ID, String trxName)
    {
...
// @SQL=SELECT COALESCE(MAX(SeqNo),0)+10 AS DefaultValue FROM AD_Tab WHERE AD_Window_ID=@AD_Window_ID@
    ...
    /** Load Constructor */
    public ADTab (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADTab[")
