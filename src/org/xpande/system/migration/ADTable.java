...
public class ADTable extends PO implements I_AD_Table, I_Persistent
{
    ...
    public ADTable (Properties ctx, int AD_Table_ID, String trxName)
    {
...
// L
    ...
    /** Load Constructor */
    public ADTable (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADTable[")
    ...
    {
		return (org.compiere.model.I_AD_Val_Rule) MTable.get(getCtx(), I_AD_Val_Rule.Table_Name)
