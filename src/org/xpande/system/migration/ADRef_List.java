...
public class ADRef_List extends PO implements I_AD_Ref_List, I_Persistent
{
    ...
    public ADRef_List (Properties ctx, int AD_Ref_List_ID, String trxName)
    {
...
// U
    ...
    /** Load Constructor */
    public ADRef_List (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADRef_List[")
    ...
    {
		return (org.compiere.model.I_AD_Reference) MTable.get(getCtx(), I_AD_Reference.Table_Name)
