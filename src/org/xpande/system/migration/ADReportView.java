...
public class ADReportView extends PO implements I_AD_ReportView, I_Persistent
{
    ...
    public ADReportView (Properties ctx, int AD_ReportView_ID, String trxName)
    {
...
// U
    ...
    /** Load Constructor */
    public ADReportView (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("ADReportView[")
    ...
    {
		return (org.compiere.model.I_AD_Table) MTable.get(getCtx(), I_AD_Table.Table_Name)
